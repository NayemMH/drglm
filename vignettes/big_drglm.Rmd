---
title: "Fitting GLMs to Out of the Memory Data Sets "
...
print(nmodel)
```
In this similar manner , we can fit other family models using the above dataset. 
